...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <footer class="p-4 bg-white shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
		<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://github.com/MikaOcko" class="hover:underline" target="_blank">MikaOcko™</a>. All Rights Reserved.</span>
